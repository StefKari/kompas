...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo bloginfo('template_directory'); ?>/css/owl.carousel.min.css" />
  <link rel="stylesheet" type="text/css" href="<?php echo bloginfo('template_directory'); ?>/css/jquery.fancybox.css" />
...
<!--            <a class="align-center mg-left" href="tel:0113982-104"><img src="/wp-content/themes/kompas/images/phone.png"><span>065555555</span></a>-->
            <a class="align-center mg-right" href="mailto:kompasbaljevac@gmail.com"><img src="/wp-content/themes/kompas/images/mail.png"><span>kompasbaljevac@gmail.com</span></a>
          </div>
        </div>
